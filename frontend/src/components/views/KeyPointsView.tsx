...
export default function KeyPointsView({ keyPoints, onOpenSource }: KeyPointsViewProps) {
  return (
    <div className="space-y-4 animate-in fade-in duration-200">
      <div className="flex items-center justify-between pb-2 border-b border-slate-800">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-slate-400">
          Extracted Key Points ({keyPoints.length})
        </h3>
        ...
        {keyPoints.map((item, index) => (
          ...
          >
            ...
            <button
              ...
              className="inline-flex items-center gap-1 rounded-lg border border-slate-800 bg-slate-950/60 px-2.5 py-1 text-xs text-slate-400 hover:border-blue-500/40 hover:text-blue-300 hover:bg-slate-900 transition-colors shrink-0"
